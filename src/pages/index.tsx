...
export default function Home() {
  ...
  if (listDataError || tagError) return <div>Something went wrong</div>;
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-zinc-900 text-slate-50">
      ...
      <LayoutWrapper allTags={tags} listItems={listData} user={user}>
        {user.isSignedIn && <Feed listData={listData} tags={tags} />}
...
function Feed({
  ...
  listData: ListItemPlusMedia[];
  tags: { tags: { id: number; name: string }[] };
}) {
  const {
    data: apiData,
