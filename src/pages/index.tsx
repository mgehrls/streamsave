    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-900 text-slate-50">
      ...
      <div className="min-h-screen w-full">
        <div className="flex h-full w-full items-start justify-center">
          <div className="flex h-full w-full max-w-5xl flex-col justify-start border-x border-slate-900">
            <header className="relative flex items-center justify-between gap-2 bg-slate-800 px-8 py-4">
